...
Namespace EmbedNoninstalledFonts
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			Dim parms As New ToPdfParameterList()
			Dim fonts As New List(Of PrivateFontPath)()
			fonts.Add(New PrivateFontPath("PT Serif Caption", "..\..\..\..\..\..\..\Data\PT_Serif-Caption-Web-Regular.ttf"))
			parms.PrivateFontPaths = fonts

			'Save the document to a PDF file.
			document.SaveToFile("EmbedNoninstalledFonts.pdf", parms)
			FileViewer("EmbedNoninstalledFonts.pdf")
		End Sub
...
'			Me.button1.Click += New System.EventHandler(Me.button1_Click)
			...
			Me.Text = "Embed Non-installed Fonts"
