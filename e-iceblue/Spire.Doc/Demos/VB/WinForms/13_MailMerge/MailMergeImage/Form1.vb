...
Namespace MailMergeImage
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			Dim spireDoc As New Document()
			spireDoc.LoadFromFile("..\..\..\..\..\..\Data\MailMergeImage.docx")
			Dim fieldNames() As String = { "ImageFile" }
			Dim fieldValues() As String = { "..\..\..\..\..\..\Data\MailMergedImage.png" }
			AddHandler spireDoc.MailMerge.MergeImageField, AddressOf MailMerge_MergeImageField
		...
		Private Sub MailMerge_MergeImageField(ByVal sender As Object, ByVal field As MergeImageFieldEventArgs)
			Dim filePath As String = field.ImageFileName
