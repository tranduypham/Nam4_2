...
'			Me.button1.Click += New System.EventHandler(Me.button1_Click)
			...
			Me.label1.Text = "Click the button to run. With Spire.Doc, you can generate, modify, convert, rende" & "r and print documents without utilizing Microsoft Word®. But you need MS Word vi" & "ewer to view the resultant document. "
			' 
			' Form1
			' 
			...
			Me.Text = "Execute conditional field including merge field"
