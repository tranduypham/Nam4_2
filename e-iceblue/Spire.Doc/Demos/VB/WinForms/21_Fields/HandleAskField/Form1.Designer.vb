Namespace HandleAskField
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.button1.Font = New Font("SimSun", 9F, FontStyle.Regular, GraphicsUnit.Point, (CByte(134)))
			Me.button1.Image = (CType(resources.GetObject("button1.Image"), Image))
			Me.button1.ImageAlign = ContentAlignment.MiddleLeft
			Me.button1.Location = New Point(382, 78)
			Me.button1.Name = "button1"
			Me.button1.Size = New Size(83, 27)
